...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD create.
    ...
    LOOP AT entities ASSIGNING FIELD-SYMBOL(<entity>).
      ...
      ELSE.
        ...
        APPEND VALUE #(
          travelid = legacy_entity_in-travel_id
          %msg     = new_message(
            id = messages[ 1 ]-msgid
  ...
  METHOD update.
    DATA:
      legacy_entity_in TYPE /dmo/travel,
      legacy_entity_x  TYPE /dmo/s_travel_inx,  "refers to x structure (> BAPIs)
      messages         TYPE /dmo/t_message.

    LOOP AT entities ASSIGNING FIELD-SYMBOL(<entity>).
      legacy_entity_in = CORRESPONDING #( <entity> MAPPING FROM ENTITY ).
      legacy_entity_x-travel_id = <entity>-TravelID.
      legacy_entity_x-_intx = CORRESPONDING zds_travel_u_ab( <entity> MAPPING FROM ENTITY ).
...
CLASS lsc_ZI_TRAVEL_AB_U DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_ZI_TRAVEL_AB_U IMPLEMENTATION.
